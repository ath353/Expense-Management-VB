<div class="mx-auto max-w-2xl animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div class="mb-8">
            <flux:heading size="xl" class="font-display">{{ __('Chỉnh sửa chi tiêu') }}</flux:heading>
            <p class="text-sm text-zinc-500 mt-1">{{ __('Cập nhật thông tin chi tiết cho khoản chi của bạn') }}</p>
        </div>
        ...
        <flux:card class="glass !p-8 !rounded-[2rem] shadow-xl shadow-zinc-900/5">
            <form wire:submit="save" class="space-y-8">
                ...
                <div class="flex justify-end gap-3 pt-6">
                    ...
                    <flux:button type="submit" variant="primary" class="rounded-xl px-8 shadow-lg shadow-primary/20">{{ __('Cập nhật chi tiêu') }}</flux:button>
                </div>
            </form>
        </flux:card>
    </div>
